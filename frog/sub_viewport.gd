...
#	DisplayServer.window_set_mouse_passthrough($Path2D.curve.get_baked_points())
	...
	var left_elbow : Node3D = $SubViewportContainer/SubViewport/Node3D/Frogdude/Frogdude2/RootNode/GeneralSkeleton/ManyBoneIK3D/LeftLowerArm
	...
	var right_elbow : Node3D = $SubViewportContainer/SubViewport/Node3D/Frogdude/Frogdude2/RootNode/GeneralSkeleton/ManyBoneIK3D/RightLowerArm
	...
	var left_knee : Node3D = $SubViewportContainer/SubViewport/Node3D/Frogdude/Frogdude2/RootNode/GeneralSkeleton/ManyBoneIK3D/LeftLowerLeg
	...
	var right_knee : Node3D = $SubViewportContainer/SubViewport/Node3D/Frogdude/Frogdude2/RootNode/GeneralSkeleton/ManyBoneIK3D/RightLowerLeg
...
func _input(event):	
	...
	var pointer_secondary : Node3D = $SubViewportContainer/SubViewport/PointerSecondary
